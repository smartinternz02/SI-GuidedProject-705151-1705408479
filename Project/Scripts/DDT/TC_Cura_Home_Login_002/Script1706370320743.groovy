...
WebUI.setText(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/input_username'), UserName)

WebUI.setText(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/input_password'), Password)
